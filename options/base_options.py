...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataset', required=True, help='dataset')
        ...
        self.parser.add_argument('--ncond', type=int, default=9, help='# of conditions')
        ...
        self.parser.add_argument('--cuda', action='store_true', help='if specified, use cuda')
        self.parser.add_argument('--hidden_size', type=int, default=512, help='hidden noise size')
